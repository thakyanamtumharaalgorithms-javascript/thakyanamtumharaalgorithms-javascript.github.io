...
let tch = Number(document.getElementById('tch').value) || 0;
let och = Number(document.getElementById('och').value) || 0;
let dis = Number(document.getElementById('dis').value) || 0;
